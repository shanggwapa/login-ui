      ...
      <footer className="w-full bg-[#8B1E1E] text-white py-16 px-6 md:px-12 mt-auto">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="flex flex-row gap-24 md:col-span-2">
              <div className="text-[16px] text-[#b7d7ee] font-bold tracking-widest uppercase">
                 <a href="#" className="hover:opacity-70">MERCH</a>
              </div>
              <div className="flex flex-col space-y-3 text-[16px] text-[#b7d7ee] font-bold tracking-widest uppercase">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-xl text-[#b7d7ee] font-black leading-tight uppercase tracking-tighter">
            ...
            <div className="flex items-start space-x-3 text-[10px] text-[#b7d7ee]">
              <input type="checkbox" className="mt-1 w-4 h-4 accent-[#b7d7ee]" />
              <label className="font-bold">
                Sign up to receive email updates and offers from:<br/>
                <span className="text-[#b7d7ee] font-black">beabadoobee</span>
              </label>
            </div>
            <button className="w-full bg-[#b7d7ee] text-white py-3 font-bold text-lg shadow-md hover:bg-white hover:text-[#b7d7ee] transition">
              SIGN UP NOW
            </button>
            <p className="text-[9px] text-[#b7d7ee] leading-tight font-medium">
        ...
        <div className="max-w-[1400px] mx-auto mt-20 pt-10 flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0 border-t border-white/1">
          <div className="grid grid-cols-5 gap-x-8 gap-y-6 text-[#b7d7ee] text-2xl md:text-4xl">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right max-w-2xl">
            <p className="text-[14px] md:text-[16px] text-[#b7d7ee] uppercase leading-tight font-bold">
              IF YOU ARE USING A SCREEN READER AND ARE HAVING PROBLEMS USING THIS WEBSITE, 
              PLEASE CALL 866-682-4413 FOR ASSISTANCE.
            </p>
            <p className="text-[14px] md:text-[16px] font-bold mt-2 text-[#b7d7ee]">© 2026 BEABADOOBEE OFFICIAL STORE</p>
          </div>
        </div>
      </footer>
